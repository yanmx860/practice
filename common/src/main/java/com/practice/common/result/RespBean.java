...
public class RespBean {
    ...
    public RespBean(int status, String msg, Object obj) {
        this.status = status; this.msg = msg; this.obj = obj;
    }
    public static RespBean ok() { return new RespBean(200, "成功", null); }
    public static RespBean ok(String msg) { return new RespBean(200, msg, null); }
    public static RespBean ok(Object obj) { return new RespBean(200, "成功", obj); }
    ...
    public static RespBean error(int status, String msg) { return new RespBean(status, msg, null); }
